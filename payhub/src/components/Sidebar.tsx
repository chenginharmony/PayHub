    ...
    <div className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen">
      <div className="p-6">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-xl font-semibold text-gray-900">PayHub</h1>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-100">
        <button
          onClick={() => signOut()}
          className="flex items-center px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 w-full"
        >
