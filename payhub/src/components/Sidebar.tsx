    ...
    <div className="bg-white h-full w-64 border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200">
        <button
          ...
          className="flex items-center w-full px-4 py-2.5 text-sm font-medium text-gray-600 rounded-lg hover:text-red-600 hover:bg-red-50 transition-all duration-200"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
